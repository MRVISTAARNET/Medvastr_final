        ...
        http
                ...
                .authorizeHttpRequests(a -> {
                    a.requestMatchers("/api/auth/**", "/auth/**").permitAll()
                            ...
                            .requestMatchers(HttpMethod.POST, "/api/orders/verify-payment", "/orders/verify-payment").permitAll()
                            .requestMatchers(HttpMethod.POST, "/api/orders/*/cancel", "/orders/*/cancel").authenticated()
                            .requestMatchers(HttpMethod.POST, "/api/payments/create-order", "/payments/create-order").permitAll()
                            .requestMatchers(HttpMethod.POST, "/api/payments/verify", "/payments/verify").permitAll()
                            ...
                            .requestMatchers("/api/analytics/admin/**", "/analytics/admin/**").hasRole("ADMIN")
                            .requestMatchers("/api/orders/admin/**", "/orders/admin/**").hasRole("ADMIN")
                            .requestMatchers(HttpMethod.POST, "/api/products/*/reviews", "/products/*/reviews").authenticated()
