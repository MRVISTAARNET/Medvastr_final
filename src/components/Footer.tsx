      ...
      <div className="ft-g">
        ...
        <div className="ft-brand">
          ...
          <div className="ft-soc-v2">
            ...
            <a href="https://g.page/r/CXy4nS7KTjN4EBM/review" target="_blank" rel="noopener" className="social-circle goog" aria-label="Google Review" title="Review us on Google">
