    ...
    <footer id="ft">
      ...
      <div className="ft-g">
        ...
        <div className="ft-brand">
          ...
          <div className="ft-soc-v2">
            ...
            <a href={`https://wa.me/918976488911?text=Hi!%20I%20have%20a%20question%20about%20Medvarn%20scrubs.`} target="_blank" rel="noopener" className="social-circle wa" aria-label="WhatsApp">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
            ...
            <a href="https://search.google.com/local/writereview?placeid=medvarn" target="_blank" rel="noopener" className="social-circle goog" aria-label="Google Review" title="Review us on Google">
      ...
      <div className="ft-btm">
        <div className="ft-copy">
          © 2026 Medvarn. All rights reserved. <br />
