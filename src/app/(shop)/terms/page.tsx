  ...
  return (
    <GenericPage title="Terms of Service" desc="Please read these terms carefully.">
      ...
      >
        ...
        <p style={{ marginBottom: "24px" }}>Delivery times are estimates and may vary based on your location and external factors. Medvarn is not responsible for delays caused by logistics partners or customs clearance processes. Risk of loss and title for items purchased pass to you upon our delivery to the carrier.</p>

        <h3 style={{ borderBottom: "1px solid #e2e8f0", paddingBottom: "12px", marginTop: "40px", color: "#0f172a" }}>5. Intellectual Property</h3>
        <p style={{ marginBottom: "24px" }}>Unless otherwise indicated, the site and its entire contents (including designs, text, and graphics) are the proprietary property of Medvarn and are protected by copyright and trademark laws. You may not use, reproduce, or distribute any content without our express written permission.</p>

        <h3 style={{ borderBottom: "1px solid #e2e8f0", paddingBottom: "12px", marginTop: "40px", color: "#0f172a" }}>6. Limitation of Liability</h3>
        <p style={{ marginBottom: "24px" }}>In no event shall Medvarn be liable for any direct, indirect, incidental, or consequential damages resulting from your use of the site or the purchase of our products. Our total liability to you for any claim shall not exceed the amount paid by you for the product in question.</p>
      </div>
    </GenericPage>
  );
}
