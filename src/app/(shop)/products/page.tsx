            ...
            {cats.map((c) => (
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: 600,
                  border: cat === c.id ? '1.5px solid #008080' : '1.5px solid #475569',
                    ...
                    {sizes.filter((s: any) => availableSizesSet.has((s.sizeValue || s.name).toUpperCase())).map((s: any) => {
                      ...
                      return (
                        <button
                          ...
                          style={{
                            padding: '8px 14px', borderRadius: '6px', fontSize: 13, fontWeight: 600,
                            border: sizeFilter === val ? '1.5px solid #008080' : '1.5px solid #475569',
